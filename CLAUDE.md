...
Avant de créer les tables SQL, tu dois analyser toutes les interfaces de `/admin/configuration`.
...
Pour chaque module de `/admin/configuration`, crée une cartographie :
...
Explique comment chaque page de `/admin/configuration` récupérera et modifiera les données.
...
3. identifie les modules de `/admin/configuration` ;
...
## B. Modules de `/admin/configuration`
